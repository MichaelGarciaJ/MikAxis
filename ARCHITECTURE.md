...
6. **Comentarios Estructurales en CSS:** Los archivos `.css` que sean extensos deben estar organizados mediante comentarios de bloque (ej: `/* ========================= */`, `/* SECCIÓN X */`) que dividan el archivo en áreas lógicas como "Variables", "Layout Principal", "Componentes Específicos", "Modales" y "Media Queries". Esto evita el código espagueti en estilos y facilita el mantenimiento.